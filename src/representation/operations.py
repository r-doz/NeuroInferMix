...
def gm_add_nd(pi1, mu1, sg1, pi2, mu2, sg2, eps: float = 1e-12):
    """
    Add two independent scalar GMs, supporting arbitrary leading dims:
      pi1,mu1,sg1: (..., K1)
      pi2,mu2,sg2: (..., K2)   (leading dims broadcastable)
...
def truncate_0_vectorized(pi, mu, sigma, eps: float = 1e-12):
    """
...
def gm_product_layer(pi_w, mu_w, sg_w, pi_x, mu_x, sg_x, eps: float = 1e-12, normalize_pi: bool = True):
    """
